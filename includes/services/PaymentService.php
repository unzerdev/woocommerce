...
class PaymentService {
	...
	public function performRefundOrReversal( $orderId, AbstractGateway $paymentGateway, $amount ): AbstractUnzerResource {
		...
		throw new Exception(
			wp_kses_post( sprintf( __( 'Unable to do refund: Maximum amount for single refund is %s.' ), html_entity_decode( strip_tags( wc_price( $maxCaptureRefund, array( 'currency' => $payment->getCurrency() ) ) ) ) ) ) .
