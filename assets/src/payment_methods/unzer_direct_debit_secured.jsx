...
const nameInSnakeCase = 'direct_debit_secured';
...
const PaymentContent = ({eventRegistration, emitResponse}) => {
    ...
    useEffect(() => {
        const unsubscribe = onPaymentSetup(onPaymentSetupFactory(paymentComponentId, 'unzer-direct-debit-secured-id', emitResponse, settings));
        return unsubscribe
    }, [onPaymentSetup])
