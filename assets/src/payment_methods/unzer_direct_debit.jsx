...
const nameInSnakeCase = 'direct_debit';
...
const PaymentContent = ({eventRegistration, emitResponse}) => {
    ...
    useEffect(() => {
        const unsubscribe = onPaymentSetup(onPaymentSetupFactory(paymentComponentId, 'unzer-direct-debit-id', emitResponse, settings));
        return unsubscribe
    }, [onPaymentSetup])
    ...
    return (
        <div>
            ...
            <unzer-payment
                ...
                locale={locale}
            >
                <unzer-sepa-direct-debit></unzer-sepa-direct-debit>
            </unzer-payment>
        </div>
    )
}
